...
(function content() {
    ...
    var oPrev    = document.getElementsByClassName('motif-prev')[0];
    var oNext    = document.getElementsByClassName('motif-next')[0];
    var oUl    = document.getElementsByClassName('motif')[0];
    var aIdots = document.getElementsByClassName('motif-idot');
